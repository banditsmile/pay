...
<body onload="autosubmit()">
	<form action="<?php echo $_SESSION['payUrl']?>" method="post" id="batchForm">
		...
		<input type="text" name="cert" value="<?php echo $_SESSION['param']['cert']?>"/><br/>
		
		<input type="text" name="payMerchant" value="<?php echo $_SESSION['param']['payMerchant']?>"/><br/>
		...
		<input type="text" name="riskInfo" value="<?php echo $_SESSION['param']['riskInfo']?>"/><br/>
