...
class AppGateway extends Gateway
{
    ...
    public function pay($endpoint, array $payload): Response
    {
        ...
        $pay_request = [
            'appid'     => $this->mode === Jdpay::MODE_SERVICE ? $payload['sub_appid'] : $payload['appid'],
            'partnerid' => $this->mode === Jdpay::MODE_SERVICE ? $payload['sub_mch_id'] : $payload['mch_id'],
        ...
        Events::dispatch(Events::PAY_STARTED, new Events\PayStarted('Jdpay', 'App', $endpoint, $pay_request));
