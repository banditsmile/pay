...
use Bandit\Pay\Gateways\Alipay\Support;
use Bandit\Pay\Log;
...
class Alipay implements GatewayApplicationInterface
{
    ...
    public function find($order, $type = 'wap', $transfer = false): Collection
    {
        if ($type === true || $transfer) {
            ...
            @trigger_error('In Bandit/pay Alipay->find(), the REFUND/TRANSFER param is deprecated since v2.7.3, use TYPE param instead!', E_USER_DEPRECATED);
